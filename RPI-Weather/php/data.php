...
$db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
 ...
 if (isset($_GET["getLast"])) {
		$sth = $db->prepare("select 
							...
							,d.D_Temperature_1 T1
							,d.D_Humidity_1 H1
							,d.D_Temperature_2 T2
							,d.D_Humidity_2 H2
							,d.D_Temperature_3 T3
							,d.D_Pressure P
							,d.D_Temperature_4 T4
							...
							,dm.DM_Temperature_1 T1
							,dm.DM_Humidity_1 H1
							,dm.DM_Temperature_2 T2
							,dm.DM_Humidity_2 H2
							,dm.DM_Temperature_3 T3
							,dm.DM_Pressure P
							,dm.DM_Temperature_4 T4
