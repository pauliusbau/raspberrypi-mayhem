...
try:
    ...
    if (oneWire != None):
        if (count_1 > 0 and count_2 > 0):
                cur.execute("""INSERT INTO duomenys_minutiniai (DM_ActualDate, DM_Temperature_1, DM_Humidity_1 ,DM_Temperature_2, DM_Humidity_2, DM_Temperature_3, DM_Info)
        ...
        if (count_1 > 0 and count_2 > 0):
                cur.execute("""INSERT INTO duomenys_minutiniai (DM_ActualDate, DM_Temperature_1, DM_Humidity_1 ,DM_Temperature_2, DM_Humidity_2, DM_Info)
                VALUES ( %s, %s,%s,%s,%s, 'MData')""",
                [sys_date,temperature_1,humidity_1,temperature_2,humidity_2])

        elif (count_1 == 0 and count_2 > 0):
                cur.execute("""INSERT INTO duomenys_minutiniai (DM_ActualDate, DM_Temperature_1, DM_Humidity_1 ,DM_Temperature_2, DM_Humidity_2, DM_Info)
                VALUES ( %s, NULL,NULL,%s,%s, 'MData')""",
                [sys_date,temperature_2,humidity_2])

        elif (count_1 > 0 and count_2 == 0):
                cur.execute("""INSERT INTO duomenys_minutiniai (DM_ActualDate, DM_Temperature_1, DM_Humidity_1 ,DM_Temperature_2, DM_Humidity_2, DM_Info)
                VALUES ( %s,%s,%s,NULL,NULL, 'MData')""",
                [sys_date,temperature_1,humidity_1])

        else :
                cur.execute("""INSERT INTO duomenys_minutiniai (DM_ActualDate, DM_Temperature_1, DM_Humidity_1 ,DM_Temperature_2, DM_Humidity_2, DM_Info)
                VALUES ( %s, NULL,NULL,NULL,NULL, 'MData')""",
                [sys_date])
